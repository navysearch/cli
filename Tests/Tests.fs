...
let ``can create message URL fragment`` () =
    createMessageUriFragment NAVADMIN 15 42 |> should equal "bupers-npc/reference/messages/Documents2/NAV2015/NAV15042.txt"
    createMessageUriFragment NAVADMIN 20 3 |> should equal "bupers-npc/reference/messages/Documents/NAVADMINS/NAV2020/NAV20003.txt"
    createMessageUriFragment ALNAV 15 9 |> should equal "bupers-npc/reference/messages/Documents/ALNAVS/ALN2015/ALN15009.txt"
    createMessageUriFragment ALNAV 20 123 |> should equal "bupers-npc/reference/messages/Documents/ALNAVS/ALN2020/ALN20123.txt"
