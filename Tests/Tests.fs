...
let ``can parse message subjects``() =
    ...
    unwrap subject subjectWithNoStartSlash
    |> should equal
           "CY 2019 WINNER ANNOUNCEMENT FOR RUSSELL EGNOR NAVY MEDIA AWARDS AND THOMPSON-RAVITZ AWARDS FOR EXCELLENCE IN NAVY PUBLIC AFFAIRS PROGRAMS"